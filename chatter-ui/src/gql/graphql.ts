...
export type ChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', _id: string, name?: string | null, userId: string, isPrivate: boolean, userIds: Array<string> } };

export type ChatsQueryVariables = Exact<{ [key: string]: never; }>;


export type ChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, name?: string | null, userId: string, isPrivate: boolean, userIds: Array<string> }> };
